...
# CREATE_DEVICE_LIBRARY uses CREATE_DEVICE_LIBRARY_each as a helper
define CREATE_LIBRARY_each
OUTDIR = $(OBJ)/$(1)
...
$$(foreach MEMORY, $$(MEMORIES), $$(eval $$(call CREATE_LIBRARY_each,$$(MEMORY),$(1),$(2),$(3))))
endef
