...
//--- ////## NB for setting up analog !

#define INPUT_LOCKOUT_MS    10          // milliseconds to go dead after input firing
#define D_IN_CHANNELS       14  //9 v9  // number of digital inputs supported ////##
#define D_OUT_CHANNELS      14  //9 v9  // number of digital outputs supported ////##
