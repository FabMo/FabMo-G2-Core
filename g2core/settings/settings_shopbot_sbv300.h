...
#define SPINDLE_ENABLE_POLARITY     0       // set this back to 0 because it was setting spindle-ON on output 1 by default; POSSIBLY mislableled above; may need adjusted for PWM control?
